...
const columnFormatter = (params: { yValue: any; highlighted: any; }) => {
            ...
            children: [
                {
                    ...
                    cellRendererSelector: (params: { data: { [x: string]: any; }; }) => {
            ...
            children: [
                {
                    ...
                    filter: 'agTextColumnFilter',
                    cellRenderer: 'agGroupCellRenderer',
                    cellRendererSelector: (params: { data: { name: any; }; }) => {
                ...
                },
                {
                    ...
                    filter: 'agNumberColumnFilter',
                    allowedAggFuncs: ['sum', 'min', 'max'],
                    cellStyle: (params: { value: number; }) => params.value > 150 ? { 'background-color': 'green' } : { 'background-color': 'red' }
                },
                {
