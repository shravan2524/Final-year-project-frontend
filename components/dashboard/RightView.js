...
function YourCompany() {
    function Active() {
        return (
            <div className="w-3 h-3 bg-red-600 rounded-full  relative top-2" style={{ background: "green" }}>
    ...
    function Block() {
        return (
            <div className="w-3 h-3 bg-red-600 rounded-full relative top-2" style={{ background: "red" }}>
    ...
    function Card({ type, total, index }) {
        const col = index % 2 ? "#F1F8FA" : "#EDF1F8";
        return (
            <div className="bg-d justify-center rounded-xl p-6 bg-gray-100 text-center" style={{ background: col }}>
    ...
    return (
        <div>
            ...
            <div className="mt-5">
                <div className="text-primary font-semibold" style={{ fontSize: "16px" }}>
                    Team Members
                </div>
                        ...
                        members.map((e) => {
                            return (<div className="flex justify-between py-3 px-6">
                                <div className="flex">
                                    ...
                                    <div className="text-xl font-bold pl-6 relative top-2">
                                        {e.name}
                                    </div>
                                </div>
...
export default function Header() {
    ...
    const color = 'green';
    return (
        <div className="mt-4 ml-6 py-4" style={{ background: "rgba(143, 146, 161, 0.05)", width: "24%" }} >
