...
export default function gstPortalCredentials() {
     return( 
        ...
        <div className="w-60 bg-grey text-center pt-36" id="leftbar">
            ...
            <div className="w-10/12 col-span-2" id="respon1">
                <div className="w-9/12 min-w-max-content max-w-screen m-auto">
                    <div>
                        <h1 className="font-bold text-3xl">GST Portal Credentials</h1>
                        <span className="text-silver">Please provide your GST login details</span>
                    </div>
                    <div className="">
